    ...
    return {
        ...
        assign_by_staff_id:
            typeof rec.assign_by_staff_id === 'string'
                ...
                : null,
        name: String(rec.name || rec.service_name || 'Dịch vụ'),
        service_name:
            typeof rec.service_name === 'string' ? rec.service_name : undefined,
        service_code:
            typeof rec.service_code === 'string' ? rec.service_code : undefined,
        specialty_id:
        ...
        room_info:
            roomId || roomName
                ? { room_id: roomId || undefined, room_name: roomName || undefined }
                : undefined,
