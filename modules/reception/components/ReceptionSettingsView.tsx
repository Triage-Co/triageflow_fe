...
import { ShiftInfo } from '@/modules/lab/types/lab.types';

export default function ReceptionSettingsView() {
    ...
    return (
        <div className="flex-1 flex flex-col overflow-y-auto bg-white rounded-tl-4xl rounded-bl-4xl p-6 md:p-10 relative">
            <div className="max-w-4xl w-full mx-auto space-y-8 pb-20">
                ...
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <p className="text-xs lg:text-sm text-slate-400 font-medium mt-1">
                            Xem và chỉnh sửa thông tin tài khoản nhân viên lễ tân
                        </p>
                    </div>
                    {profile?.role && (
                            ...
                            {isLoadingShifts ? (
                                ...
                                <div className="mt-1 text-right">
                                    <p className="text-[11.5px] font-extrabold text-slate-700">
                                        Ca trực: {activeShift.room?.room_name || 'Quầy tiếp đón'}
                                    </p>
                                ...
                                <div className="mt-1 text-right">
                                    <p className="text-[11.5px] font-extrabold text-slate-500">
                ...
                {errorMessage && (
                    <div className="bg-red-50 border border-red-200 text-red-700 rounded-[14px] p-4 text-xs font-bold">
                        {errorMessage}
                    </div>
                )}
                        ...
                        >
                            <div className="flex flex-col items-center gap-1.5">
                                ...
                                <p className="text-xs font-bold text-slate-700">
                                    Kéo thả ảnh vào đây <span className="text-slate-400 font-normal">hoặc</span>{' '}
                                    <span className="text-[#8B7CF6]">nhấp để chọn file</span>
                                </p>
                            ...
                            {pwStep === 'success' && (
                                <div className="flex flex-col items-center gap-3 py-4 text-center">
                                    ...
                                    <p className="text-xs text-slate-500">
                                        Mật khẩu mới đã được cập nhật. Sử dụng mật khẩu mới cho lần đăng nhập tiếp theo.
                                    </p>
                                    <button
                                        type="button"
                                        onClick={handleToggleChangePassword}
                            ...
                            {pwStep === 'send_otp' && (
                                <div className="space-y-3">
                                    <p className="text-xs text-slate-500 leading-relaxed">
                                        ...
                                        <span className="font-bold text-slate-700">{profile?.email}</span> để xác nhận
