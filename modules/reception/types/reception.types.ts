...
export interface ReceptionAccount { account_id: string; patient_id?: string; full_name: string; citizen_id: string; email: string; dob: string; gender: string; role: string; phone: string | null; bhyt?: string | null; blood_type?: string | null; allergy_notes?: string | null; createdAt?: string; }
export interface ReceptionPatientRecord { patient_id: string; medical_coverage_id?: string | null; account?: { account_id?: string; full_name: string; citizen_id: string; email: string; dob: string; gender: string; role?: string; phone: string | null; }; full_name?: string; citizen_id?: string; email?: string; dob?: string; gender?: string; phone?: string | null; blood_type?: string | null; allergy_notes?: string | null; createdAt?: string; updatedAt?: string; }
export interface ReceptionSlot { slot_id?: string; id?: string; doctor_id?: string; start_time: string; end_time: string; capacity?: number; max_capacity?: number; status?: string; is_full?: boolean; room_name?: string; room?: { room_name?: string; name?: string; room_number?: string; }; shift?: { shift_id?: string; date?: string; }; }
...
export interface ReceptionSpecialty { specialty_id?: string; specialty_code?: string; doctor_id?: string; name?: string; specialty_name?: string; specialty_labels?: string[]; experience_years?: number; gender?: string; license_number?: string; avatar_url?: string; academic_degree?: string; rating?: number; review_count?: number; room_name?: string; }
export interface CreateBookingRequest { patient_id: string; slot_id: string; }
export interface CreateBookingWithPackageRequest { patient_id: string; slot_id: string; package_id: string; return_url?: string; cancel_url?: string; }
