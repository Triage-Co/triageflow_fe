                                ...
                                {paginated.map((rule) => {
                                    ...
                                    return (
                                        <tr key={rule.rule_id} className="hover:bg-neutral-50/80">
                                            <td className="px-4 py-3 font-mono text-xs text-neutral-600">{rule.rule_code}</td>
                                            <td className="px-4 py-3">
                                                <span className="font-semibold text-neutral-800">{rule.name}</span>
                                                {rule.description && (
                                                    <p className="text-[11px] text-neutral-400 mt-0.5 max-w-[220px] truncate">
                                                        {rule.description}
                                                    </p>
                                                )}
                                            </td>
                                            <td className="px-4 py-3 text-neutral-600 text-[12px]">{ruleTypeLabel(rule.rule_type)}</td>
                                            <td className="px-4 py-3 text-right font-mono text-xs">{rule.weight}</td>
                                            <td className="px-4 py-3 text-right font-mono text-xs">
                                                {rule.aging_rate}/{rule.max_aging}
                                            </td>
                                            <td className="px-4 py-3 text-neutral-600 text-[12px]">{roomTypeLabel(rule.room_type)}</td>
