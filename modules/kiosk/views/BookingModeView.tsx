    ...
    <div className="w-full min-h-screen p-6 lg:p-10 z-10 select-none flex flex-col justify-between max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch my-auto py-4">
        ...
        >
          ...
          <div className="space-y-3 my-6">
            <h3 className="text-xl sm:text-2xl font-black text-[#1E2939] group-hover:text-indigo-600 transition-colors leading-snug">
              Gợi ý chẩn đoán AI trước khi đặt
            </h3>
            <p className="text-xs sm:text-sm text-neutral-500 font-medium leading-relaxed">
              Chọn vùng đau và trả lời khảo sát ngắn. Hệ thống AI sẽ phân tích và đề xuất chuyên khoa phù hợp.
            </p>
          </div>
        ...
        >
          ...
          <div className="space-y-3 my-6">
            <h3 className="text-xl sm:text-2xl font-black text-[#1E2939] group-hover:text-teal-600 transition-colors leading-snug">
              Đặt lịch khám theo gói dịch vụ
            </h3>
            <p className="text-xs sm:text-sm text-neutral-500 font-medium leading-relaxed">
