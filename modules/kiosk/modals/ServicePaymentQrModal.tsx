...
interface ServicePaymentQrModalProps {
  isOpen: boolean;
  onClose: () => void;
  qrResult: {
    qrCode: string;
...
export const ServicePaymentQrModal: React.FC<ServicePaymentQrModalProps> = ({
  isOpen,
  onClose,
  qrResult,
  patientId,
  ...
  useEffect(() => {
    ...
    const checkPaymentStatus = async () => {
      try {
        ...
        const currentOrder = pendingOrders.find((order: any) => order.service_order_id === serviceOrderId);
