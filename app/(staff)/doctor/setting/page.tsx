...
// ── Settings Form Component matching Figma UI & New API ────────────────────────
function SettingsForm({
    ...
    profile: UserProfile;
    onSave: (data: { userName: string; gender: Gender; extPhone: string; avatar: string | null }) => Promise<void>;
    isSaving: boolean;
}) {
...
export default function DoctorSettingsPage() {
    ...
    const handleSave = async (data: { userName: string; gender: Gender; extPhone: string; avatar: string | null }) => {
